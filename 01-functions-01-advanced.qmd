...
If you are planning to attend [Tidy Dev Day](https://www.tidyverse.org/blog/2025/07/tdd-2025/), just after posit::conf(2025), there are a [couple of issues related to this material](https://github.com/r-lib/rlang/issues?q=is%3Aissue%20state%3Aopen%20label%3A%22tidy-dev-day%20%3Anerd_face%3A%22) that you might be interested to work on.
...
We will show you the tools the Tidyverse team use, themselves, as of Summer 2025.
We can offer our best advice for now, but we suspect something more-documented and more-supported is on the way.
...
::: {.callout-tip}
From the `r-programming-exercises` project, open the file `functions-01-advanced-type-check.R`.
...
As of Summer 2025, these functions are available:
