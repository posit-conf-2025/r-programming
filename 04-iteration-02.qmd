...
To display on slides, let's use a simpified `penguins` dataset (sorry Allison!):
...
Run the code through `dpurrr_to_list()` and `dpurrr_to_tibble()`, then experiment with:
...
```{r echo=FALSE}
mtcars_list <- mtcars |> dpurrr_to_list()
...
::: {.column .opacity-67 width="16%"}
```{r echo=FALSE}
str_element(mtcars_list, 1)
```
:::

::: {.column .opacity-67 width="16%"}
```{r echo=FALSE}
str_element(mtcars_list, 2)
```
:::

::: {.column .opacity-67 width="16%"}
```{r echo=FALSE}
str_element(mtcars_list, 3)
```
:::

::: {.column .opacity-67 width="16%"}
```{r echo=FALSE}
str_element(mtcars_list, 4)
```
:::

::: {.column .opacity-67 width="16%"}
```{r echo=FALSE}
str_element(mtcars_list, 5)
```
:::

::: {.column .opacity-67 width="16%"}
```{r echo=FALSE}
str_element(mtcars_list, 6)
```
:::
...
::: {.column width="16%"}
```{r echo=FALSE}
str_element(mtcars_mutate_list, 1)
```
:::

::: {.column width="16%"}
```{r echo=FALSE}
str_element(mtcars_mutate_list, 2)
```
:::

::: {.column width="16%"}
```{r echo=FALSE}
str_element(mtcars_mutate_list, 3)
```
:::

::: {.column width="16%"}
```{r echo=FALSE}
str_element(mtcars_mutate_list, 4)
```
:::

::: {.column width="16%"}
```{r echo=FALSE}
str_element(mtcars_mutate_list, 5)
```
:::

::: {.column width="16%"}
```{r echo=FALSE}
str_element(mtcars_mutate_list, 6)
```
:::
